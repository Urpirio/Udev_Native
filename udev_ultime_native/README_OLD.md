...
**Nota:** El estado de visibilidad de contraseña (`ShowPassword`) se maneja internamente por el componente. En la versión 3.5.0, se optimizaron las props eliminando eventos no utilizados.
